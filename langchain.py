...
def build_qa_messages(question: str, context: str, language: str = 'Français') -> list[str]:
    language_instruction = {
        'Français': "Répondez en français.",
        'Anglais': "Answer in English.",
        'Espagnol': "Responda en español.",
        'Allemand': "Antworten Sie auf Deutsch."
    }.get(language, "Répondez en français.")
...
def answer_question(question: str, language: str = 'Français') -> str:
    ...
    # Add language context to the messages if needed
